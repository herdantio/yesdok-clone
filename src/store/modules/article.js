...
<p>Menyusui adalah salah satu latihan nyata bagi ibu baru. Kebiasaan ini juga membantu menekan kembalinya periode (haid) dan menenangkan. Berkurangnya stres juga dapat meningkatkan kontrol kadar gula darah dan kualitas hidup wanita setelah melahirkan.</p>
...
- Tetap terhidrasi</p>`
            ...
            {
                id: '2',
                title: 'Studi: Penggunaan Rokok Elektrik yang Rutin Bisa Bantu Berhenti Merokok',
                image: 'article2.png',
                category: 'GAYA HIDUP',
                body: `<p>Sebuah studi baru yang diterbitkan King&#39;s College London menyoroti &#39;manfaat yang jelas&#39; dari menggunakan rokok elektrik atau vape setiap hari untuk membantu berhenti merokok.</p>

<p>Hasil penelitian ini menunjukkan bahwa ketika digunakan setiap hari, rokok elektrik membantu orang untuk berhenti merokok, dibandingkan dengan tidak ada bantuan sama sekali.&nbsp;</p>

<p>Temuan ini sejalan dengan penelitian sebelumnya, menunjukkan bahwa vape adalah bantuan yang lebih efektif untuk berhenti merokok daripada terapi penggantian nikotin dan obat yang diresepkan.</p>

<p>Dalam studi yang didanai Cancer Research UK, para peneliti menganalisis data dari survei online terhadap lebih dari 1.155 orang, termasuk perokok, mantan perokok yang telah berhenti dalam satu tahun sebelum menyelesaikan survei, dan pengguna rokok elektrik.</p>

<p>Lima gelombang data dikumpulkan antara tahun 2012 dan 2017. Para peneliti menganalisis efektivitas rokok elektrik dalam membantu berhenti merokok setidaknya selama satu bulan pada masa tindak lanjut, dan setidaknya satu bulan antara survei pertama dan berikutnya.</p>

<p>Diterbitkan di jurnal Addiction, penelitian ini menemukan bahwa orang yang menggunakan rokok elektrik isi ulang setiap hari untuk berhenti merokok memiliki kemungkinan lima kali lebih besar untuk tidak merokok selama satu bulan, dibandingkan dengan mereka yang tidak menggunakan alat bantu berhenti sama sekali.</p>

<p>Demikian pula, orang yang menggunakan rokok elektrik sekali pakai atau setiap hari tiga kali lebih mungkin untuk berhenti selama satu bulan, dibandingkan dengan mereka yang tidak menggunakan bantuan.</p>`
            },
            {
                id: '3',
